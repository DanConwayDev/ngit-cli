...
- **Push to a nostr remote via `Repo::nostr_push`, never
  ...
  auto-generated kind-30618 state event deterministically, including
  same-second replacements. See
  `docs/architecture/test-harness.md` § "Replaceable-event ordering".
