...
- `ngit send --in-reply-to` now errors before publishing an update to an existing proposal when the signer is neither the proposal author nor a repository maintainer.
